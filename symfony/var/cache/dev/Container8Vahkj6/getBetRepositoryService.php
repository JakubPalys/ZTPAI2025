 ...
 */
class getBetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BetRepository' shared autowired service.
     *
     * @return \App\Repository\BetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BetRepository.php';

        return $container->privates['App\\Repository\\BetRepository'] = new \App\Repository\BetRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
